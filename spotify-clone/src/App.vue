...
const playlists = ref([]);
const accessToken = 'BQBxux3xYgXpznO93ZUKuu4U_p7m7llbvknRA3W-72ipR7QZNLdjodDdZfVYz7ZswyzJKjV6gYmSeZkAHfYPqvpLRwAbNjOh7-TQJKLf3GeLC-RXnFYWIzAFnNtoFWujDsmnrz8-bPYLr9hs8V-vL1uuQK3L_u7UmEB2rlCdBjzLAh6pwEtrJ0T0znpTY3cufdWUwGLhXfY_W_zGR7zpBrdSUX1gPY_W2wf2V7Kc_NwMIg_Bb6WLLjVLvlijpgI8sNoF'; // Store your access token securely
            ...
            <button @click="openMenu = !openMenu" :class="openMenu ? 'bg-[#282828]' : 'bg-black'"
                ...
                <div class="flex items-center">
                    <img 
                      class="rounded-full" 
                      width="27"
                      src="https://yt3.ggpht.com/yti/ANjgQV8ee-GRSF-UpHannioig83Ffq2MSvDKItzhO7mY6dMpNWU=s108-c-k-c0x00ffffff-no-rj"
                    >
                    <div class="text-white text-[14px] ml-1.5 font-semibold">Filipe Abreu</div>
